...
<form class="layui-form bform" method="post" action="<?php echo U('Announce/doedit');?>" enctype="multipart/form-data">
  <input type="hidden" name="annid" value="<?php echo ($c["annid"]); ?>">
  ...
  <div class="layui-form-item">
    <label class="layui-form-label">缩略图</label>
     ...
     <input class="file-txt" type="text" autocomplete="off" name="textfield" id="textfield"><?php if($c[annpic] != ''): ?><img src="/CWP/admin/Uploads<?php echo ($c["annpic"]); ?>" height="50"><?php else: endif; ?>
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea name="anncontent" placeholder="请输入内容" class="layui-textarea"><?php echo ($c["anncontent"]); ?></textarea>
    </div>
  </div>
