...
<div class="aright">
    ...
    <div style="float: left;margin: 0px 20px 20px 30px;">
        <form class="layui-form" action="<?php echo U('Apply/chaxun');?>" method="get">
            <input placeholder="输入关键字" name="keyword"  type="text" class="layui-input" style="float: left;margin-right: 10px;width: 300px;">
            <button class="layui-btn submitBtn" style="float: left;" value="查询" type="submit">查询</button>
        </form>
    </div>


        <table width="100%" class="aform cl">
            <tr>

                <th width="5%" align="center">反馈标号</th>
                <th width="5%" align="center">关键字</th>
                <th width="20%" align="center">反馈详情</th>
                <th width="10%" align="center">反馈时间</th>
                <th width="5%" align="center">联系方式</th>
                <th width="5%">操作</th>
            </tr>
            <?php if(is_array($c)): foreach($c as $k=>$vo): ?><tr>

                    <td align="center"height="30"><?php echo ($vo["appid"]); ?></td>
                    <td align="center"><?php echo ($vo["applytype"]); ?></a></td>
                    <td align="center"><?php echo ($vo["applycontent"]); ?></td>
                    <td align="center"><?php echo ($vo["applytime"]); ?></td>
                    <td align="center"><?php echo ($vo["applynumber"]); ?></td>
                    <td align="center"><a class="layui-btn layui-btn-mini layui-btn-danger" href="<?php echo U('apply/applydelete',array('appid'=>$vo['appid']));?>" onclick="return confirm('您确定要删除吗？');">删除</a>
                    </td>
