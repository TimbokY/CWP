angular.module('dynamicModule',[]).controller('dynamicCtrl',function($ionicSlideBoxDelegate,$state,$scope,$ionicSideMenuDelegate,$ionicLoading,$ionicPopup,$rootScope,$ionicHistory){
    ...
    function getAnnounce() {
        $.ajax({
            url:'http://localhost/CWP/service/admin.php/home/announce/getAnnounce',
            type:'post',
            dataType:'json',
            success:function (data) {
                //data = JSON.parse(data);
                console.log(data);
                $scope.anns = data.content;
                $scope.$apply();
    ...
    function getDynamicBydate() {
        $.ajax({
            url:'http://localhost/CWP/service/admin.php/home/dynamic/getDynamicBydate/id/'+nowUserId,
            type:'post',
            dataType:'json',
            success:function (data) {
                console.log(data);
    ...
    function getDynamicByLikeCount() {
        $.ajax({
            url:'http://localhost/CWP/service/admin.php/home/dynamic/getDynamicByLikeCount/id/'+nowUserId,
            type:'post',
            dataType:'json',
            success:function (data) {
                console.log(data);
    ...
    $scope.changeLike = function (dynId,obj,islike) {
        ...
        $.ajax({
            url:'http://localhost/CWP/service/admin.php/home/like/changeLike/id/'+nowUserId,
            type:'post',
            data:{
                dynid:dynId,
                islike:islike,
    ...
    $scope.changeHate = function (dynId,obj,ishate) {
        ...
        $.ajax({
            url:'http://localhost/CWP/service/admin.php/home/hate/changeHate/id/'+nowUserId,
            type:'post',
            data:{
                dynid:dynId,
                ishate:ishate,
    ...
    $scope.tiaozhuan = function(id) {
        ...
        $scope.id=id;
        console.log(id);
        var song = JSON.stringify($scope.anns[id]);
        console.log(song);
        localStorage.setItem('announce',song);
    }
