angular.module('mineModule',[])
    .controller('mineCtrl',function($state,$scope,$ionicHistory,$ionicSlideBoxDelegate,$ionicPopup){
        ...
        function getMyComment() {
            ...
            //console.log(id);
            $.ajax({
                url:'http://localhost/CWP/service/admin.php/home/dynamic/getMyComment/id/'+id,
                type:'post',
                dataType:'json',
        ...
        function getMyLike() {
            ...
            //console.log(id);
            $.ajax({
                url:'http://localhost/CWP/service/admin.php/home/dynamic/getMyLike/id/'+id,
                type:'post',
                dataType:'json',
                success:function (data) {
                    console.log(data);
        ...
        function commentMyDynamic() {
            ...
            //console.log(userid);
            $.ajax({
                url:'http://localhost/CWP/service/admin.php/Home/Comment/commentMyDynamic/userid/'+userid,
                type:'post',
                dataType:'json',
                success:function (data) {
                    console.log(data);
        ...
        function likeMyDynamic() {
            ...
            //console.log(userid);
            $.ajax({
                url:'http://localhost/CWP/service/admin.php/Home/Comment/likeMyDynamic/userid/'+userid,
                type:'post',
                dataType:'json',
                success:function (data) {
                    console.log(data);
        ...
        $scope.deleteComMy=function (index) {
           ...
           // console.log("需要删除的评论我的评论id "+comid);
            ...
            function deleteCom(comid) {
                $.ajax('http://localhost/CWP/service/admin.php/Home/Comment/deleteCom/comId/'+comid,
                    {
                        type: 'get',
                        datatype: 'json',
                        success: function (data) {
        ...
        $scope.deleteMyCom=function (index) {
            ...
            function deleteCom(dcId) {
                $.ajax('http://localhost/CWP/service/admin.php/Home/Dynamic/deleteCom/comId/'+dcId,
                    {
                        type: 'get',
                        datatype: 'json',
                        success: function (data) {
