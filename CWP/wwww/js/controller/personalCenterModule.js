angular.module('personalCenterModule',[]).controller('personalCenterCtrl',function($state,$scope,$ionicPopup,$ionicActionSheet){
    $scope.goPersonSideMenu = function () {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://172.16.121.36/CWP/service/admin.php/Home/User/editPic',
            data:formData,
            dataType:"json",
            processData: false,
            contentType: false,
    ...
    vm.CityPickData = {
        ...
        buttonClicked: function(callback) {
            ...
            $.ajax({
                url:'http://172.16.121.36/CWP/service/admin.php/Home/User/editHomePlace',
                type:'post',
                data:{
                    userId:userId,
    ...
    $scope.saveUser = function () {
        ...
        //console.log(userId);
        $.ajax({
            url:'http://172.16.121.36/CWP/service/admin.php/Home/User/doEdit',
            type:'post',
            data:{
                userId:userId,
