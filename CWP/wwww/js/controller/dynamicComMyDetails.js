angular.module('dynamicComMyDetailsModule',[]).controller('dynamicComMyDetailsCtrl',function($state,$scope){
   ...
   // console.log("接收的评论我的数据commentsMy" + localStorage.getItem('commentsMy'));
   //数据的json格式
    ...
    $scope.commentsMy = data;

    var dynId = $scope.commentsMy.dynid;
        ...
        $.ajax('http://172.16.121.36/CWP/service/admin.php/Home/Comment/getDynComment/dynId/' + dynId,
            {
                ...
                success: function (data) {
                    if (data.code > 0) {
                        ...
                        console.log("接口返回的评论我的数据"+$scope.comments);
