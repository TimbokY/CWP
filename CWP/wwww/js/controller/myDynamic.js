angular.module('myDynamicModule',[])
    ...
    $scope.delete = function (id) {
        $.ajax({
            url:'http://172.16.121.36/CWP/service/admin.php/home/dynamic/deleteDynamic/id/'+id,
            type:'post',
        ...
        function getOtherDynamic() {
            $.ajax({
                url:'http://172.16.121.36/CWP/service/admin.php/home/dynamic/getMyDynamic/id/'+otherUserId,
                type:'post',
                dataType:'json',
                success:function (data) {
                    //console.log(data);
        ...
        $scope.changeHate = function (dynId,obj,ishate) {
            ...
            $.ajax({
                url:'http://172.16.121.36/CWP/service/admin.php/home/hate/changeHate/id/'+otherUserId,
                type:'post',
                data:{
                    dynid:dynId,
                    ishate:ishate,
        ...
        $scope.changeLike = function (dynId,obj,islike) {
            ...
            $.ajax({
                url:'http://172.16.121.36/CWP/service/admin.php/home/like/changeLike/id/'+otherUserId,
                type:'post',
                data:{
                    dynid:dynId,
                    islike:islike,
