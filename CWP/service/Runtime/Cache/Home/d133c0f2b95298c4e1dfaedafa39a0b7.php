...
<head>
    ...
    <link rel="stylesheet" href="/Demo/CWP/service/Public/css/admin.css">
    <link rel="stylesheet" href="/Demo/CWP/service/Public/layui/css/layui.css">
    <script src="/Demo/CWP/service/Public/layui/layui.js"></script>
    <link rel="stylesheet" href="/Demo/CWP/service/Public/css/style.css">
...
<div class="admin">
    <div class="aleft">
        ...
        <ul class="cl">
            <li><i class="layui-icon">&#xe631;</i><a href="<?php echo U('User/index');?>">密码修改</a></li>
...
<script src="/Demo/CWP/service/Public/js/jquery-1.4.2.min.js"></script>
<div class="aright">
    <div class="arz" style="float: left;margin: 0px 20px 20px 30px;"><a href="<?php echo U('User/add');?>"><i class="layui-icon">&#xe608;</i>添加账号</a></div>

    <div style="float: left;">
        <form class="layui-form" action="http://localhost/Demo/CWP/service/admin.php/Home/User/index.html" method="get">
    ...
    <form method="post" class="aform cl" action="<?php echo U('User/deletes');?>">
        <table width="100%">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <?php if($vo[userpic] != ''): ?><img src="/Demo/CWP/service/Images<?php echo ($vo["userpic"]); ?>" height="30">
                            <?php else: ?>
                            暂无缩略图<?php endif; ?>
                    </td>
